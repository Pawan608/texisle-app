$(document).ready(function(){
    try{
        ...
        if (stock.rc_index.data >= 0)
            document.getElementById("rc_val_data1").innerHTML = "+" + (stock.rc_index.data);
        else
            document.getElementById("rc_val_data_neg1").innerHTML = (stock.rc_index.data);
    
        document.getElementById("dpr_duc_val_current1").innerHTML = (stock.DPR_DUC.current);
        if (stock.DPR_DUC.data >= 0)
            document.getElementById("dpr_duc_val_data1").innerHTML = "+" + (stock.DPR_DUC.data);
        else
            document.getElementById("dpr_duc_val_data_neg1").innerHTML = (stock.DPR_DUC.data);
        ...
        if (stock.rc_index.data >= 0)
            document.getElementById("rc_val_data").innerHTML = "+" + (stock.rc_index.data);
        else
            document.getElementById("rc_val_data_neg").innerHTML = (stock.rc_index.data);

        document.getElementById("ardmore_val_current").innerHTML = (stock.Ardmore_data.current);
        if (stock.Ardmore_data.data >= 0)
            document.getElementById("ardmore_val_data").innerHTML = "+" + (stock.Ardmore_data.data);
        else
            document.getElementById("ardmore_val_data_neg").innerHTML = (stock.Ardmore_data.data);

        document.getElementById("arkoma_val_current").innerHTML = (stock.Arkoma_data.current);
        if (stock.Arkoma_data.data >= 0)
            document.getElementById("arkoma_val_data").innerHTML = "+" + (stock.Arkoma_data.data);
        else
            document.getElementById("arkoma_val_data_neg").innerHTML = (stock.Arkoma_data.data);    

        document.getElementById("barnett_val_current").innerHTML = (stock.Barnett_data.current);
        if (stock.Barnett_data.data >= 0)
            document.getElementById("barnett_val_data").innerHTML = "+" + (stock.Barnett_data.data);
        else
            document.getElementById("barnett_val_data_neg").innerHTML = (stock.Barnett_data.data);    

        document.getElementById("cana_val_current").innerHTML = (stock.Cana_data.current);
        if (stock.Cana_data.data >= 0)
            document.getElementById("cana_val_data").innerHTML = "+" + (stock.Cana_data.data);
        else
            document.getElementById("cana_val_data_neg").innerHTML = (stock.Cana_data.data);
    
        document.getElementById("niobrara_val_current").innerHTML = (stock.Niobrara_data.current);
        if (stock.Niobrara_data.data >= 0)
            document.getElementById("niobrara_val_data").innerHTML = "+" + (stock.Niobrara_data.data);
        else
            document.getElementById("niobrara_val_data_neg").innerHTML = (stock.Niobrara_data.data);    

        document.getElementById("ford_val_current").innerHTML = (stock.Ford_data.current);
        if (stock.Ford_data.data >= 0)
            document.getElementById("ford_val_data").innerHTML = "+" + (stock.Ford_data.data);
        else
            document.getElementById("ford_val_data_neg").innerHTML = (stock.Ford_data.data);    
        
        document.getElementById("granite_val_current").innerHTML = (stock.Granite_data.current);
        if (stock.Granite_data.data >= 0)
            document.getElementById("granite_val_data").innerHTML = "+" + (stock.Granite_data.data);
        else
            document.getElementById("granite_val_data_neg").innerHTML = (stock.Granite_data.data);    

        document.getElementById("haynesville_val_current").innerHTML = (stock.Haynesville_data.current);
        if (stock.Haynesville_data.data >= 0)
            document.getElementById("haynesville_val_data").innerHTML = "+" + (stock.Haynesville_data.data);
        else
            document.getElementById("haynesville_val_data_neg").innerHTML = (stock.Haynesville_data.data);    

        document.getElementById("marcellus_val_current").innerHTML = (stock.Marcellus_data.current);
        if (stock.Marcellus_data.data >= 0)
            document.getElementById("marcellus_val_data").innerHTML = "+" + (stock.Marcellus_data.data);
        else
            document.getElementById("marcellus_val_data_neg").innerHTML = (stock.Marcellus_data.data);    
        ...
        if (stock.Mississippian_data.data >= 0)
            document.getElementById("mississippian_val_data").innerHTML = "+" + (stock.Mississippian_data.data);
        else
            document.getElementById("mississippian_val_data_neg").innerHTML = (stock.Mississippian_data.data);    

        document.getElementById("permian_val_current").innerHTML = (stock.Permian_data.current);
        if (stock.Permian_data.data >= 0)
            document.getElementById("permian_val_data").innerHTML = "+" + (stock.Permian_data.data);
        else
            document.getElementById("permian_val_data_neg").innerHTML = (stock.Permian_data.data);    
            
        document.getElementById("utica_val_current").innerHTML = (stock.Utica_data.current);
        if (stock.Utica_data.data >= 0)
            document.getElementById("utica_val_data").innerHTML = "+" + (stock.Utica_data.data);
        else
            document.getElementById("utica_val_data_neg").innerHTML = (stock.Utica_data.data);    

        document.getElementById("williston_val_current").innerHTML = (stock.Williston_data.current);
        if (stock.Williston_data.data >= 0)
            document.getElementById("williston_val_data").innerHTML = "+" + (stock.Williston_data.data);
        else
            document.getElementById("williston_val_data_neg").innerHTML = (stock.Williston_data.data);
            
        document.getElementById("dpr_duc_val_current").innerHTML = (stock.DPR_DUC.current);
        if (stock.DPR_DUC.data >= 0)
            document.getElementById("dpr_duc_val_data").innerHTML = "+" + (stock.DPR_DUC.data);
        else
            document.getElementById("dpr_duc_val_data_neg").innerHTML = (stock.DPR_DUC.data);

        document.getElementById("Anadarko_duc_val_current").innerHTML = (stock.Anadarko_DUC.current);
        if (stock.Anadarko_DUC.data >= 0)
            document.getElementById("Anadarko_duc_val_data").innerHTML = "+" + (stock.Anadarko_DUC.data);
        else
            document.getElementById("Anadarko_duc_val_data_neg").innerHTML = (stock.Anadarko_DUC.data);

        document.getElementById("Appalachia_duc_val_current").innerHTML = (stock.Appalachia_DUC.current);
        if (stock.Appalachia_DUC.data >= 0)
            document.getElementById("Appalachia_duc_val_data").innerHTML = "+" + (stock.Appalachia_DUC.data);
        else
            document.getElementById("Appalachia_duc_val_data_neg").innerHTML = (stock.Appalachia_DUC.data);

        document.getElementById("Bakken_duc_val_current").innerHTML = (stock.Bakken_DUC.current);
        if (stock.Bakken_DUC.data >= 0)
            document.getElementById("Bakken_duc_val_data").innerHTML = "+" + (stock.Bakken_DUC.data);
        else
            document.getElementById("Bakken_duc_val_data_neg").innerHTML = (stock.Bakken_DUC.data);

        document.getElementById("Eagle_duc_val_current").innerHTML = (stock.Eagle_DUC.current);
        if (stock.Eagle_DUC.data >= 0)
            document.getElementById("Eagle_duc_val_data").innerHTML = "+" + (stock.Eagle_DUC.data);
        else
            document.getElementById("Eagle_duc_val_data_neg").innerHTML = (stock.Eagle_DUC.data);
        ...
        if (stock.Haynesville_DUC.data >= 0)
            document.getElementById("Haynesville_duc_val_data").innerHTML = "+" + (stock.Haynesville_DUC.data);
        else
            document.getElementById("Haynesville_duc_val_data_neg").innerHTML = (stock.Haynesville_DUC.data);

        document.getElementById("Niobrara_duc_val_current").innerHTML = (stock.Niobrara_DUC.current);
        if (stock.Niobrara_DUC.data >= 0)
            document.getElementById("Niobrara_duc_val_data").innerHTML = "+" + (stock.Niobrara_DUC.data);
        else
            document.getElementById("Niobrara_duc_val_data_neg").innerHTML = (stock.Niobrara_DUC.data);

        document.getElementById("Permian_duc_val_current").innerHTML = (stock.Permian_DUC.current);
        if (stock.Permian_DUC.data >= 0)
            document.getElementById("Permian_duc_val_data").innerHTML = "+" + (stock.Permian_DUC.data);
        else
            document.getElementById("Permian_duc_val_data_neg").innerHTML = (stock.Permian_DUC.data);
